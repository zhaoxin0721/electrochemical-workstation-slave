...
AppIMPCfg_Type AppIMPCfg = 
{
  ...
  .SensorCh0.LptiaRtiaSel = LPTIARTIA_4K, /* COnfigure RTIA */
  .SensorCh0.LpTiaRf = LPTIARF_1M,        /* Configure LPF resistor */
...
static AD5940Err AppIMPSeqCfgGen(void)
{
  ...
  lploop_cfg.LpDacCfg.DacData6Bit = (uint32_t)((AppIMPCfg.SensorCh0.Vzero-200)/DAC6BITVOLT_1LSB);
  lploop_cfg.LpDacCfg.DacData12Bit =(int32_t)((AppIMPCfg.SensorCh0.SensorBias)/DAC12BITVOLT_1LSB) + lploop_cfg.LpDacCfg.DacData6Bit*64;
  ...
  lploop_cfg.LpAmpCfg.LpTiaRf = AppIMPCfg.SensorCh0.LpTiaRf;
  lploop_cfg.LpAmpCfg.LpTiaRload = AppIMPCfg.SensorCh0.LpTiaRl;
  lploop_cfg.LpAmpCfg.LpTiaRtia = AppIMPCfg.SensorCh0.LptiaRtiaSel;
  ...
  HsLoopCfg.SWMatCfg.Tswitch = SWT_OPEN;
...
static AD5940Err AppIMPSeqMeasureGen(void)
{
  ...
  LpAmpCfg.LpTiaRf = AppIMPCfg.SensorCh0.LpTiaRf;
  LpAmpCfg.LpTiaRload = AppIMPCfg.SensorCh0.LpTiaRl;
  LpAmpCfg.LpTiaRtia = LPTIARTIA_OPEN; /* Disconnect Rtia to avoid RC filter discharge */
  LpAmpCfg.LpTiaSW = LPTIASW(7)|LPTIASW(4)|LPTIASW(12)|LPTIASW(13); 
  ...
  AD5940_SWMatrixCfgS(&sw_cfg);
  /* Reconnect LP loop */
  LpAmpCfg.LpTiaRtia = AppIMPCfg.SensorCh0.LptiaRtiaSel; /* Reconnect Rtia */
  LpAmpCfg.LpTiaSW = LPTIASW(5)|LPTIASW(2)|LPTIASW(8)|LPTIASW(12)|LPTIASW(13); 
  AD5940_LPAMPCfgS(&LpAmpCfg);
