...
//   .PwrMod = AFEPWR_LP,
//   /* LPTIA Configure */
//   .SensorCh0.LptiaRtiaSel = LPTIARTIA_10K,
//   .SensorCh0.LpTiaRf = LPTIARF_1M,
//   .SensorCh0.LpTiaRl = LPTIARLOAD_SHORT,
//   .SensorCh0.Vzero = 1100,
...
//       fifo_cfg.FIFOSrc = AppCHRONOAMPCfg.DataFifoSrc;
...
//   AppCHRONOAMPCfg_Type *pChronoampCfg;
//   AppCHRONOAMPGetCfg(&pChronoampCfg);
...
//   lp_loop.LpDacCfg.DacData6Bit = (uint32_t)((AppCHRONOAMPCfg.SensorCh0.Vzero-200)/DAC6BITVOLT_1LSB);
//   lp_loop.LpDacCfg.DacData12Bit =(int32_t)((AppCHRONOAMPCfg.SensorCh0.SensorBias)/DAC12BITVOLT_1LSB) + lp_loop.LpDacCfg.DacData6Bit*64;
...
//   lp_loop.LpAmpCfg.LpTiaRf = AppCHRONOAMPCfg.SensorCh0.LpTiaRf;
//   lp_loop.LpAmpCfg.LpTiaRload = AppCHRONOAMPCfg.SensorCh0.LpTiaRl;	
//   lp_loop.LpAmpCfg.LpTiaRtia = AppCHRONOAMPCfg.SensorCh0.LptiaRtiaSel;
//   if(lp_loop.LpAmpCfg.LpTiaRtia == LPTIARTIA_OPEN)
//     lp_loop.LpAmpCfg.LpTiaSW = LPTIASW(9)|LPTIASW(2)|LPTIASW(4)|LPTIASW(5)/*|LPTIASW(12)|LPTIASW(13)*/; 
//   else
//     lp_loop.LpAmpCfg.LpTiaSW = LPTIASW(5)|LPTIASW(2)|LPTIASW(4)/*|LPTIASW(15)|LPTIASW(13)*/; 
//   AD5940_LPLoopCfgS(&lp_loop);
  
//   dsp_cfg.ADCBaseCfg.ADCMuxP = pChronoampCfg->ADCMuxP;
//   dsp_cfg.ADCBaseCfg.ADCMuxN = pChronoampCfg->ADCMuxN;
...
//   VzeroCode = (uint32_t)((AppCHRONOAMPCfg.SensorCh0.Vzero-200)/DAC6BITVOLT_1LSB);
//   VbiasCode = (int32_t)((AppCHRONOAMPCfg.pulseAmplitude + AppCHRONOAMPCfg.SensorCh0.SensorBias)/DAC12BITVOLT_1LSB) + VzeroCode*64;
...
//   clks_cal.DataType = DATATYPE_SINC2;// AppCHRONOAMPCfg.DataFifoSrc;
...
//   AD5940_WriteReg(REG_AFE_LPDACDAT0,(uint32_t)((AppCHRONOAMPCfg.SensorCh0.Vzero-200)/DAC6BITVOLT_1LSB)<<12|(int32_t)((AppCHRONOAMPCfg.SensorCh0.SensorBias)/DAC12BITVOLT_1LSB) + VzeroCode*64);
//   AD5940_SEQGenInsert(SEQ_WAIT(WaitClks));                      /* wait for first data ready */
...
//   lprtia_cal.LpTiaRtia = AppCHRONOAMPCfg.SensorCh0.LptiaRtiaSel;
//   AD5940_LPRtiaCal(&lprtia_cal, &RtiaCalValue);
//   AppCHRONOAMPCfg.SensorCh0.RtiaCalValue = RtiaCalValue;
...
//   if(AppCHRONOAMPCfg.DataFifoSrc == FIFOSRC_SINC2NOTCH)
//     temp = time*800/sinc2osr_table[AppCHRONOAMPCfg.ADCSinc2Osr]/sinc3osr_table[AppCHRONOAMPCfg.ADCSinc3Osr];
//   else
//     temp = time*800/sinc3osr_table[AppCHRONOAMPCfg.ADCSinc3Osr];
  
//   if(temp > MAXDATANUM)
//   {
//     printf("Buffer limited error \n");
...
//   fVoltage = AD5940_ADCCode2Volt(ADCcode, AppCHRONOAMPCfg.ADCPgaGain, AppCHRONOAMPCfg.ADCRefVolt);
//   fCurrent = fVoltage/AppCHRONOAMPCfg.SensorCh0.RtiaCalValue.Magnitude;
